...
TEST_CASE("targa", "[targa io]")
{
    ...
    REQUIRE_NOTHROW(Targa::write("images/targa_blank.tga", imageBuffer));

    std::ifstream f("images/targa_blank.tga");
    REQUIRE(f.good());

    Buffer2D<Targa::TargaFormat> fromFile = Targa::read("images/targa_blank.tga");
